...
async function signInTenant() {
    ...
    // make post request
    fetch('https://rentalapp-297023.ue.r.appspot.com/tenant/signin', {
        method: 'POST',
        body: JSON.stringify({
...
async function signInHost() {
    ...
    // make post request
    fetch('https://rentalapp-297023.ue.r.appspot.com/host/signin', {
        method: 'POST',
        body: JSON.stringify({
...
async function signUpTenant() {
    ...
    // make post request
    fetch('https://rentalapp-297023.ue.r.appspot.com/tenant/signup', {
        method: 'POST',
        body: JSON.stringify({
            "tenant_id": username.value,
...
async function signUpHost() {
    ...
    // make post request
    fetch('https://rentalapp-297023.ue.r.appspot.com/host/signup', {
        method: 'POST',
        body: JSON.stringify({
            "host_id": username.value,
